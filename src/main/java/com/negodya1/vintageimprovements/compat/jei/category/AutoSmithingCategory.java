...
public class AutoSmithingCategory extends CreateRecipeCategory<AutoUpgradeRecipe> {
	...
	public void draw(AutoUpgradeRecipe recipe, IRecipeSlotsView iRecipeSlotsView, PoseStack graphics, double mouseX, double mouseY) {
		...
		instance.font.draw(graphics,
				Component.translatable(VintageImprovements.MODID + ".jei.text.auto_smithing.text1"), 96, 3, 0xFAFAFA);
		instance.font.draw(graphics,
				Component.translatable(VintageImprovements.MODID + ".jei.text.auto_smithing.text2"), 96, 14, 0xFAFAFA);
		instance.font.draw(graphics,
				Component.translatable(VintageImprovements.MODID + ".jei.text.auto_smithing.text3"), 96, 25, 0xFAFAFA);
		instance.font.draw(graphics,
				Component.translatable(VintageImprovements.MODID + ".jei.text.auto_smithing.text4"), 96, 36, 0xFAFAFA);
		instance.font.draw(graphics,
				Component.translatable(VintageImprovements.MODID + ".jei.text.auto_smithing.text5"), 96, 47, 0xFAFAFA);
		instance.font.draw(graphics,
				Component.translatable(VintageImprovements.MODID + ".jei.text.auto_smithing.text6"), 96, 58, 0xFAFAFA);
	}
